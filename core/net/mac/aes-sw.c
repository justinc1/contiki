...
#include "aes.h"
    ...
    #define CONTIKI_ON_PC
  #elif defined( CONTIKI_TARGET_MINIMAL_NET_2 )
    #define CONTIKI_ON_PC
...
void copy_block( void *d, const void *s )
{
#if defined( HAVE_UINT_32T )
...
/* Compile error, replaced by function below */
...
return_type aes_cbc_encrypt( const unsigned char *in, unsigned char *out,
                         unsigned int n_block, unsigned char iv[N_BLOCK], const aes_context ctx[1] )
{
